...
- **Security** — Reentrancy, flash loan attacks, access control patterns, OpenZeppelin libraries, Slither/Aderyn static analysis
- **Gas optimization** — Storage packing, calldata vs memory, assembly (Yul) for hot paths, batch operations
